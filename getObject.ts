...
import { GetObjectCommand, GetObjectOutput } from '@aws-sdk/client-s3-node/commands/GetObjectCommand'
/**
 * S3 getObject
 * @see {@link http://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/S3.html#getObject-property}
 */
export function getObject(s3client:S3Client, opts:GetObjectInput):Promise<GetObjectOutput> {
