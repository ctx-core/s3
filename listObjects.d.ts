 ...
 */
export declare function listObjects(s3client: S3Client, opts: ListObjectsInput): Promise<import("@aws-sdk/client-s3-node/types/ListObjectsOutput").ListObjectsOutput>;
